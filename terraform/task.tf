...
resource "aws_ecs_task_definition" "tesla_http_proxy_task" {
  ...
  execution_role_arn = data.terraform_remote_state.secrets_proxy.outputs.iam.tesla_proxy_exec_role.arn
  task_role_arn      = data.terraform_remote_state.secrets_proxy.outputs.iam.tesla_proxy_task_role.arn
